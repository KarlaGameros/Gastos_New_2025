      ...
      <div class="col-9">
        <div class="q-pa-md q-gutter-sm">
          ...
          <q-breadcrumbs>
            ...
            <q-breadcrumbs-el class="text-grey-7" label="Gastos a comprobar" />
          </q-breadcrumbs>
        </div>
      </div>
    </div>
...
import TablaComp from "../solicitudes_RF_GC/components/TablaComp.vue";
import ModalComp from "../solicitudes_RF_GC/components/ModalComp.vue";
import ModalReintegro from "../solicitudes_RF_GC/components/ModalReintegro.vue";
